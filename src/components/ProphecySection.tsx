...
const ProphecySection = () => {
  ...
  useEffect(() => {
    ...
    const phases = [
      ...
      { delay: 1000, phase: 2 },  // Prophecy modules detected
  ...
  const ProphecyModule = ({ prophecy }) => {
    const IconComponent = prophecy.icon;
    
    return (
      <div className={`relative group bg-black/40 backdrop-blur-xl border-2 border-${prophecy.color}-500/30 rounded-xl p-8 hover:scale-105 transition-all duration-500 overflow-hidden hover:border-${prophecy.color}-500/60`}>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className={`transition-all duration-1000 delay-500 ${phase >= 2 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {prophecies.map((prophecy) => (
              <ProphecyModule key={prophecy.id} prophecy={prophecy} />
            ))}
          </div>
        </div>
        ...
        <div className={`transition-all duration-1000 delay-1000 ${phase >= 3 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="bg-black/40 backdrop-blur-xl border border-cyan-500/30 rounded-xl p-8">
            ...
            {/* System Status Panel */}
            <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4 text-xs font-mono">
              <div className="text-center p-3 bg-cyan-500/10 border border-cyan-500/30 rounded">
                <div className="text-cyan-400 mb-1">FLOOD_MODULE</div>
                <div className="text-white font-bold">STANDBY</div>
              </div>
              <div className="text-center p-3 bg-yellow-500/10 border border-yellow-500/30 rounded">
                <div className="text-yellow-400 mb-1">CHOSEN_ALGO</div>
              ...
              <div className="text-center p-3 bg-emerald-500/10 border border-emerald-500/30 rounded">
                <div className="text-emerald-400 mb-1">GENESIS_SYS</div>
