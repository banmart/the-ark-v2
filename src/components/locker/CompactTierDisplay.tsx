...
const CompactTierDisplay = () => {
  ...
  const TierCard = ({
    ...
    return <div className={`
      ...
      `}>
        ...
        {tier.special && <div className="absolute top-1 left-1 bg-orange-400/20 border border-orange-400/40 text-orange-400 px-1 py-0.5 rounded text-xs font-mono">
            LEG
          </div>}

        {/* Active Tier Pulse */}
        {isActive && <div className={`absolute inset-0 bg-gradient-to-br from-${tier.color}/10 to-transparent opacity-50 animate-pulse rounded-lg`}></div>}
  ...
  return <section className="relative max-w-6xl mx-auto px-6 py-8">
