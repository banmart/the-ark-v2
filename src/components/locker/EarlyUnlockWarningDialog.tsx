...
const EarlyUnlockWarningDialog = ({
  ...
  return (
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent className="left-0 top-0 translate-x-0 translate-y-0 max-w-none sm:left-[50%] sm:top-[50%] sm:translate-x-[-50%] sm:translate-y-[-50%] sm:max-w-md w-full h-full sm:h-auto sm:max-h-[85vh] overflow-y-auto bg-white text-gray-900 rounded-none sm:rounded-lg">
        <AlertDialogHeader>
