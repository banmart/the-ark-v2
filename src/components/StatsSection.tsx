  ...
  const statsCards = [
    {
      ...
      icon: DollarSign,
      label: 'MARKET CAP',
      value: arkLoading || !arkData ? null : `$${formatNumber(arkData.marketCap)}`,
    ...
    },
    {
      ...
      icon: Coins,
      label: 'TOTAL SUPPLY',
      value: arkLoading || !arkData ? null : formatNumber(arkData.totalSupply),
    ...
    },
    {
      ...
      icon: Activity,
      label: 'CIRCULATING',
      value: arkLoading || !arkData ? null : formatNumber(arkData.circulatingSupply),
    ...
    },
    {
      ...
      icon: Flame,
      label: 'BURNED',
      value: arkLoading || !arkData ? null : formatNumber(arkData.burnedTokens),
