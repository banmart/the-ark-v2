...
const BurnAddressBreakdown: React.FC<{ data: any }> = ({ data }) => {
  const total = data.totalBurnAddressBurns + data.totalPenaltyBurns;
        ...
        <div className="space-y-3">
          <div>
            <div className="flex justify-between text-sm mb-2">
              <span className="text-white/90">Regular Burns (0x000...369)</span>
          ...
          <div>
            <div className="flex justify-between text-sm mb-2">
              <span className="text-white/90">Penalty Burns (0x000...369)</span>
