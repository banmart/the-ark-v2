      ...
      <div className="max-w-7xl mx-auto w-full relative z-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            {/* Tech HUD Elements */}
            <div className="absolute -top-8 -left-4 text-cyan-400/30 text-xs font-mono">
              [SYSTEM_INIT] 0x7A8B9C2D
            </div>
            <div className="absolute -top-8 right-0 text-cyan-400/30 text-xs font-mono">
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className={`transition-all duration-2000 delay-1500 ${textPhase >= 4 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6 font-mono text-xs">
                  <div className="bg-black/30 border border-cyan-500/30 rounded p-2">
                    <div className="text-cyan-400">CONTRACT_ADDR</div>
                    <div className="text-white truncate">0xACC15eF8fa2e702d0138c3662A9E7d696f40F021</div>
                  </div>
