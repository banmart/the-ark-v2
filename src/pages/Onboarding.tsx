      ...
      <div className="min-h-screen bg-black text-white">
        ...
        <div className="px-6 mb-16">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-cyan-400 mb-4 font-mono tracking-wider">
                [ASCENSION_PROTOCOL]
              </h2>
              <p className="text-gray-400 max-w-2xl mx-auto">
                Follow these divine steps to complete your ARK onboarding
              </p>
            </div>
            <ProcessFlow />
          </div>
        ...
        <div className="px-6 mb-16">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-8">
              <h3 className="text-xl md:text-2xl font-bold text-cyan-400 mb-4 font-mono tracking-wider">
                [ASSET_ACQUISITION_SERVICES]
              </h3>
              <p className="text-gray-400">Get crypto to start your ARK journey</p>
            </div>
        ...
        <div className="px-6 mb-20">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-8">
              <h3 className="text-xl md:text-2xl font-bold text-cyan-400 mb-4 font-mono tracking-wider">
                [ARK_ECOSYSTEM_PROTOCOLS]
              </h3>
              <p className="text-gray-400">Essential actions for ARK participation</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {arkActions.map((action, index) => (
