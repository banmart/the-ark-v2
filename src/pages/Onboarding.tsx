  ...
  return (
    <BaseLayout>
      <div className="min-h-screen bg-black text-white relative overflow-hidden flex flex-col">
          ...
          <div className="max-w-3xl mx-auto px-4 py-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="relative">
                ...
                <div className="relative w-9 h-9 rounded-full bg-white/[0.05] border border-white/[0.1] flex items-center justify-center">
                  <MessageCircle className="w-4 h-4 text-cyan-400" />
                </div>
              </div>
              <div>
                <h1 className="text-sm font-bold font-mono tracking-wide bg-gradient-to-r from-cyan-400 to-teal-400 bg-clip-text text-transparent">
          ...
          <div className="max-w-3xl mx-auto px-4 py-6">
            {!hasMessages ? (
              ...
              <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
                <div className="mb-6">
                  <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/[0.03] border border-white/[0.08] rounded-xl mb-6">
                    <Sparkles className="w-3.5 h-3.5 text-cyan-400" />
                    <span className="text-[11px] font-mono text-white/60 tracking-widest">AI-POWERED ONBOARDING</span>
                  </div>

                  <h2 className="text-2xl md:text-3xl font-bold mb-3 bg-gradient-to-r from-cyan-400 via-teal-300 to-green-400 bg-clip-text text-transparent">
                    Let's get you onboard ⚓
                  </h2>
                  <p className="text-white/50 text-sm max-w-md mx-auto leading-relaxed">
                    I'll walk you through every step — from zero to holding ARK in your own wallet. Where are you starting from?
                  </p>
                </div>
                ...
                <div className="w-full max-w-sm space-y-2.5">
                  {audienceOptions.map((opt) => (
                    <button
                      ...
                      disabled={isLoading}
                      className="w-full text-left px-4 py-3.5 bg-white/[0.03] border border-white/[0.08] rounded-xl hover:border-cyan-500/40 hover:bg-cyan-500/5 transition-all duration-200 group disabled:opacity-50"
                    >
        ...
        {/* Chat Input — only show after first message */}
        {hasMessages && (
          <div className="relative z-10 border-t border-white/[0.06] bg-black/60 backdrop-blur-xl">
